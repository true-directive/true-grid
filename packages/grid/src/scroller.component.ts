...
import { NgModule, Component, Input, Output, ViewChild,
         ...
         ContentChild, HostListener, QueryList, Inject, HostBinding,
...
export class ScrollerComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    this.renderer.listen(this.data.nativeElement, 'scroll', (e: any) => this.doScroll(e));
    this.renderer.listen(this.datah.nativeElement, 'scroll', (e: any) => this.doScroll(e, true));
  }
